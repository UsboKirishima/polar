...
- Alcune procedure richiedono paginazione per evitare sovvraccarichi del server. In particolare
  `user.getAll`, `user.getFriends`, `post.getAll`, `post.getFeed`, `post.getSaved`,
  `category.getAll`.
