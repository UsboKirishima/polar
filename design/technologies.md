...
The backend architecture is designed around a **RESTful API** built with the **Express.js** framework.  
The guiding principles are **simplicity, maintainability, and scalability**, avoiding unnecessary abstractions or non-standard communication protocols.  
...
This sequencing allows us to validate product requirements and user flows before committing to backend structures, reducing the need for costly refactoring.

---

## Frontend (Web Application)

The frontend will prioritize **user experience (UX)** through a **minimal and accessible interface**.  
A **dark, dimmed color palette** will be adopted to enhance visual comfort and distinguish application components.
...
While more feature-rich frameworks exist, Vue.js is considered the most appropriate for the project’s initial scope.
...
Its development will be considered **only after** the web frontend and backend are stable and validated.

### Preliminary Considerations

- Reuse of backend APIs for cross-platform consistency  
- Potential use of **cross-platform frameworks** (e.g., React Native, Flutter) to reduce development overhead  
