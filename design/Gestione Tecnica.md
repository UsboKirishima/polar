...
- [x] Migliorare la gestione dei template riutilizzabili
- [ ] Ruoli e badges
- [ ] Tutta la parte della chat
...
- [ ] Ottimizzazione db con indicizzazione
- [x] Rate limiter e security stuff
- [ ] Implementare BetterAuth (e Google)
...
- [ ] ? Futura app mobile (React Native e Expo)
