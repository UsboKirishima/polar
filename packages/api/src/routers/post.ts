    ...
    getById: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            try {
                ...
                if (!post) return resultErr('Failed to find post.')
    ...
    edit: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            try {
                ...
                if (!updatedPost) return resultErr(`Failed to update post`)
    ...
    delete: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            try {
                ...
                return resultOk(
                    `Post with id (${input}) was successfully deleted.`
                )
            } catch (error) {
                return internalErr()
            }
    ...
    getCommentById: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            try {
                ...
                if (!comment) return resultErr('Comment not found.')
    ...
    createComment: protectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            try {
                ...
                if (!comment) return resultErr('Failed to create comment.')
        ...
        .mutation(async ({ input, ctx }) => {
            try {
                ...
                if (
                    ...
                    return resultErr(
                        'You can delete only your comments, or comments under your posts.'
                    )
