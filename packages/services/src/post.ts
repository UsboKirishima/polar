 ...
 */
export const createNewPost = async (userId: string, post: TPostSchema) => {
...
export const getCommentById = async (commentId: string) => {
    ...
    const cached = await cacheManager.get<GetCommentById>(cacheKey)
...
export const getPostByid = async (postId: string) => {
    ...
    const cached = await cacheManager.get<GetPostById>(cacheKey)
...
export const getPostsByUserId = async (userId: string) => {
    ...
    const cached = await cacheManager.get<GetPostByUserId>(cacheKey)
...
export const getAllPosts = async () => {
    ...
    const cached = await cacheManager.get<GetAllPosts>(cacheKey)
...
export const getAllCategories = async () => {
    ...
    const cached = await cacheManager.get<GetAllCategories>(cacheKey)
...
export const getCategoryById = async (categoryId: number) => {
    ...
    const cached = await cacheManager.get<GetCategoryById>(cacheKey)
...
export const getCategoryByName = async (categoryName: string) => {
    ...
    const cached = await cacheManager.get<GetCategoryByName>(cacheKey)
